...
function runCplBackup() {
  ...
  const raceResults = fetchAllRows_(supabaseUrl, secretKey, 'race_results', 'id,race_id,finish_position,popularity,win_odds,chest,hindquarter,gait,balance,tone,agitation,sweating,fast_walking,paddock_evaluation,created_at');
